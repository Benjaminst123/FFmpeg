...
static const AVOption vdpau_options[] = {
    ...
    { "pipeline_size", "set number of frames to upload before using them", OFFSET(pipeline_size), AV_OPT_TYPE_INT, {.i64 = 1}, 0, MAX_PIPELINE_SIZE},
    ...
    { "noise_reduction", "set noise reduction level", OFFSET(noise_reduction),   AV_OPT_TYPE_FLOAT, {.dbl = 0}, 0, 1.0, FLAGS },
    { "sharpness", "set sharpness level", OFFSET(sharpness), AV_OPT_TYPE_FLOAT, {.dbl = 0},  -1, 1, FLAGS },
    ...
    { "size",   "set output video size",          OFFSET(size_str), AV_OPT_TYPE_STRING, {.str = NULL}, 0, FLAGS },
